...
import com.example.alfred.chatapp2.Fragments.ChatsFragment;
import com.example.alfred.chatapp2.Fragments.ProfileFragment;
import com.example.alfred.chatapp2.Fragments.UsersFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.d("mImage", user.getId() + user.getImageURL());
                assert user != null;
